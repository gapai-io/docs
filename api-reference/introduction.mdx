...
<Steps>
  ...
  <Step title="Project">
    A workspace inside a tenant. Projects own environments, webhooks, and installed integrations.
  </Step>
  <Step title="Environment">
    A deployable instance of a project. Environments have variables, artifacts, and deploy actions.
  </Step>
  <Step title="Resource">
