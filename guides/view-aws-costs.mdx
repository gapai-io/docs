...
Gapstack can then attribute costs to environment resources, and group that spend by project. If a tag is not activated in AWS, those resources do not appear in tagged cost data.
