...
<Steps>
  ...
  <Step title="Open the AWS authorization page">
    ...
    <Warning>
      Do not change the CloudFormation template, stack name, parameters, or region. The connection stack must be created in `us-west-1`. You can still deploy projects to any supported region.
    </Warning>
